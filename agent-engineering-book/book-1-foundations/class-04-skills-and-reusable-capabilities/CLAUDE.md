...
Currently at Chapter 4 (Skills and Reusable Capabilities). One Skill exists
— `.claude/skills/account-research/` — invoked directly, with no
subagents, tools, memory, or planning yet. Subagents start Chapter 8.
